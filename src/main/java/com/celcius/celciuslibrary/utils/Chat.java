...
public class Chat  {
    ...
    private final String serverVersion = core.getServerVersion();
    ...
    /*public void registerHooks() {
        hookMap.put("koliseo", new ReplacementHook());
    }*/
    ...
    public String replace(OfflinePlayer player, OfflinePlayer target, String str, String text, boolean color, boolean prefix) {
        ...
        if(prefix){
            return color ? str(core.getPlugin().getLang().getString("prefix") + text) : core.getPlugin().getLang().getString("prefix") + text;
        }else{
